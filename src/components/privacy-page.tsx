...
const copy = {
  ar: {
    ...
    sections: [
      ...
      ["مدة الاحتفاظ بالبيانات", "تُحفظ سجلات الحجز وسجلات التواصل المرتبطة بها لمدة 12 شهرًا من تاريخ آخر تحديث، ما لم يقتضِ الأمر مدة أطول لأسباب قانونية أو تشغيلية موثقة."],
    ],
  ...
  en: {
    ...
    sections: [
      ...
      ["Data retention period", "Booking records and their associated communications records are retained for 12 months from the date of last update, unless a longer period is required for documented legal or operational reasons."],
    ],
