...
export function RevenueSections() {
  ...
  const copy = isArabic
    ? {
        ...
        contactBody: "يمكنك إرسال طلب التقييم من النموذج أو التواصل عبر واتساب. إرسال الطلب لا يعني أن الموعد أصبح مؤكدًا.",
    ...
    : {
        ...
        contactBody: "Submit the assessment form or continue on WhatsApp. Sending a request does not mean the appointment is confirmed.",
