...
export const CHATBOT_KNOWLEDGE: readonly ChatbotKnowledgeEntry[] = [
  {
    ...
    questions: {
      ar: [
        ...
        "ما نوع خدمات السباحة لديكم؟",
        "هل تساعدون على تعلم السباحة؟",
        "هل يوجد تدريب لتحسين تقنية السباحة؟",
        "أريد بناء الثقة في الماء",
        "ما برامج السباحة المتوفرة؟",
        "هل تقدمون تدريبًا لتحسين الأداء؟",
      ],
      en: [
        "What services do you offer?",
        "Which services are available?",
        "What swimming services do you provide?",
        "Do you help people learn swimming?",
        "Do you offer swimming technique coaching?",
        "I want to build confidence in the water",
        "What swimming programmes are available?",
        "Do you provide performance coaching?",
      ],
    },
    answer: {
  ...
  },
  {
    ...
    questions: {
      ar: [
        "ما الأسعار؟",
        "ما أسعار تدريب الأطفال؟",
        "كم تكلفة التدريب؟",
        "كم سعر تدريب السباحة؟",
        "ما تكلفة الحصة بالدرهم؟",
        "هل يوجد سعر خاص للإخوة؟",
        "كم سعر الطفل في المجموعة؟",
        "أريد معرفة أسعار الخدمات",
      ],
      en: [
        "What are your prices?",
        "How much do lessons cost in AED?",
        "How much is the coaching?",
        "What is the swimming price?",
        "What is the session cost in dirhams?",
        "Is there a sibling price?",
        "What is the group price per child?",
        "I want to know the service pricing",
      ],
    },
    answer: {
  ...
  },
  {
    ...
    questions: {
      ar: [
        ...
        "كيف أبدأ الحجز؟",
        "هل يمكنني حجز تقييم؟",
        "أريد اختيار موعد وموقع",
        "هل الطلب يؤكد الموعد؟",
        "كيف أحجز لأطفالي؟",
      ],
      en: [
        "I want to book an assessment appointment",
        "How do I book?",
        "I want to request an initial assessment",
        "How do I start a booking?",
        "Can I book an assessment?",
        "I want to choose an appointment and location",
        "Does submitting a booking confirm the appointment?",
        "How do I book for my children?",
      ],
    },
    answer: {
  ...
  },
  {
    ...
    questions: {
      ar: [
        "أين مواقع التدريب؟",
        "أين موقع المشرف على الخريطة؟",
        "ما أقرب موقع تدريب؟",
        "أريد رابط خريطة الموقع",
        "هل لديكم موقع في النجدة؟",
        "هل يوجد تدريب في خليفة؟",
        "ما المواقع المتاحة؟",
        "كيف أختار موقع التدريب؟",
      ],
      en: [
        "Where are the training locations?",
        "Where is the Najda location?",
        "Which location is nearest?",
        "I need the location map link",
        "Do you have a location in Najda?",
        "Is coaching available in Khalifa?",
        "What locations are available?",
        "How do I choose a training location?",
      ],
    },
    answer: {
  ...
  },
  {
    ...
    questions: {
      ar: [
        ...
        "ما أوقات التدريب؟",
        "ما ساعات العمل؟",
        "هل يوجد وقت متاح اليوم؟",
        "أريد معرفة جدول المواعيد",
        "متى يبدأ التدريب؟",
        "ما المواعيد المتاحة في نهاية الأسبوع؟",
      ],
      en: [
        "When are you open?",
        "What are the general hours?",
        "What training times are available?",
        "What are your working hours?",
        "Is there an available time today?",
        "I want to know the schedule",
        "When does the training start?",
        "What times are available on the weekend?",
      ],
    },
    answer: {
  ...
  },
  {
    ...
    questions: {
      ar: [
        "هل يوجد تدريب للكبار؟",
        "أريد تعلم السباحة للبالغين",
        "تدريب للكبار",
        "أنا بالغ ومبتدئ في السباحة",
        "هل تقبلون بالغين لا يعرفون السباحة؟",
        "أريد تدريب سباحة للكبار",
        "هل توجد جلسات للبالغين؟",
        "كيف يبدأ البالغ التدريب؟",
      ],
      en: [
        "Do you offer adult swimming?",
        "I want adult swimming coaching",
        "Adult swimming",
        "I am an adult swimming beginner",
        "Do you accept adults who cannot swim?",
        "I need swimming coaching for adults",
        "Are adult sessions available?",
        "How does an adult start coaching?",
      ],
    },
    answer: {
  ...
  },
  {
    ...
    questions: {
      ar: [
        "هل يوجد تدريب للأطفال؟",
        "أريد تدريب أطفالي",
        "ما أسعار تدريب الأطفال؟",
        "أريد حجز تدريب لابني",
        "هل يمكن للأب حجز تدريب للطفل؟",
        "هل يمكن للأم تقديم طلب للأطفال؟",
        "كم عدد الأطفال في المجموعة؟",
        "أريد تدريب سباحة لابنتي",
      ],
      en: [
        "Do you offer kids swimming?",
        "I want coaching for my children",
        "Kids swimming",
        "I want to book coaching for my son",
        "Can a father book for a child?",
        "Can a mother submit a request for children?",
        "How many children are in the group?",
        "I want swimming coaching for my daughter",
      ],
    },
    answer: {
  ...
  },
  {
    ...
    questions: {
      ar: [
        "هل يوجد تدريب للسيدات؟",
        "أريد تدريبًا للسيدات",
        "هل توجد حصة مخصصة للسيدات؟",
        "هل يوجد تدريب سباحة للنساء؟",
        "أريد مدربة أو خيارًا مناسبًا للسيدات",
        "هل تتوفر مواعيد للسيدات؟",
        "كيف أحجز تدريبًا للسيدات؟",
        "هل يمكن تأكيد حصة سيدات؟",
      ],
      en: [
        "Do you offer ladies swimming?",
        "I want ladies coaching",
        "Is a ladies-only session available?",
        "Do you provide swimming coaching for women?",
        "I need a suitable coaching option for ladies",
        "Are times available for ladies?",
        "How do I book ladies coaching?",
        "Can you confirm a ladies session?",
      ],
    },
    answer: {
  ...
  },
  {
    ...
    questions: {
      ar: [
        ...
        "أريد التواصل مع الفريق",
        "ما رقم الواتساب؟",
        "أريد التحدث مع شخص",
        "هل يمكنني الاتصال بالفريق؟",
        "أعطني وسيلة التواصل",
        "أريد رقم هاتف أو واتساب",
        "كيف أتحدث مع موظف؟",
      ],
      en: [
        "How can I contact the team?",
        "I need to speak to a person on WhatsApp",
        "What is your WhatsApp number?",
        "I want to speak to a person",
        "Can I call the team?",
        "Please give me the contact details",
        "I need a phone or WhatsApp number",
        "How do I speak to a staff member?",
      ],
    },
    answer: {
