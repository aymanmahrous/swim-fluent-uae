...
const unapprovedFreeClaimPattern =
  /(?:مجاني|مجاناً|مجانًا|بدون\s+مقابل|free(?:\s+(?:assessment|consultation|session|first assessment))?|complimentary(?:\s+(?:assessment|consultation|session|first assessment))?|no[-\s]?cost)/iu;
