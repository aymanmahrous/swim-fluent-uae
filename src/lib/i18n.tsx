...
export const t = {
  ...
  feat2d: { ar: "7+ سنوات خبرة، نادي الجزيرة، إسعافات وإنقاذ.", en: "7+ years experience, Al Jazeera Club, first aid & rescue certified." },
  ...
  feat4: { ar: "نتيجة في 8 حصص", en: "Results in 8 Sessions" },
