...
export const t = {
  ...
  pod: { ar: "أصحاب الهمم", en: "People of Determination" },
  ...
  disclaimerText: {
    ar: "أوافق على تعليمات السلامة والتنظيم الخاصة بالتدريب، وعدم دخول المسبح قبل توجيه المدرب، والالتزام بتعليمات التجهيز والمواعيد وسياسة إعادة الجدولة.",
    en: "I agree to the coaching safety and operating rules, including no pool entry before coach instruction, required preparation, attendance rules, and the rescheduling policy.",
  },
  ...
  success: {
    ar: "تم حفظ طلبك بنجاح. سنراجع الموعد ونتواصل معك عبر واتساب.",
    en: "Your request has been saved. We will review the slot and contact you on WhatsApp.",
  },
  why: { ar: "لماذا Relax Fix UAE؟", en: "Why Relax Fix UAE?" },
  feat1: { ar: "خبرة عملية", en: "Practical Experience" },
  feat1d: {
    ar: "خبرة طويلة في تعليم السباحة وبناء الثقة داخل الماء لمستويات وفئات مختلفة.",
    en: "Years of practical coaching across different ages, levels, and water-confidence needs.",
  },
  feat2: { ar: "سلامة أولاً", en: "Safety First" },
  feat2d: {
    ar: "التقدم يبدأ من الأمان والسيطرة والتنفس الصحيح قبل السرعة أو المسافة.",
    en: "Progress starts with safety, control, and breathing before speed or distance.",
  },
  feat3: { ar: "خطة تناسب الحالة", en: "Coaching Built Around You" },
  feat3d: {
    ar: "تقييم واضح ثم أسلوب تدريب مناسب للهدف والخوف والخبرة السابقة.",
    en: "A clear assessment followed by coaching matched to your goals, confidence, and experience.",
  },
  ...
  heroTitle: {
    ar: "لا تتعلم السباحة فقط. تعلم كيف تثق بنفسك داخل الماء.",
    en: "Don't just learn to swim. Learn to trust yourself in the water.",
  },
  heroBody: {
    ar: "من أول خوف من الماء إلى تحسين التقنية والأداء، تبدأ الخطة بتقييم واضح وتدريب مناسب لحالتك مع كوتش أيمن.",
    en: "From first-time water fear to stronger technique and performance, your plan starts with a clear assessment and coaching built around you.",
  },
  ...
  programsBody: {
    ar: "اختيار البرنامج النهائي يتم بعد فهم الهدف والخبرة السابقة ومستوى الراحة داخل الماء.",
    en: "The final coaching path is chosen after understanding your goal, previous experience, and comfort in the water.",
  },
  ...
  programAdaptive: { ar: "تدريب مائي مخصص", en: "Adaptive Aquatic Coaching" },
  programAdaptiveD: { ar: "جلسات مخصصة لأصحاب الهمم مع مراعاة الحالة والقدرات الفردية.", en: "Individualized aquatic coaching for People of Determination, adapted to ability and need." },
  specialtiesTitle: { ar: "الماء يمكن أن يكون مساحة ثقة وتطور", en: "Water Can Become a Place of Confidence and Progress" },
  rehabTitle: { ar: "تدريب مائي داعم للحركة", en: "Supportive Aquatic Movement" },
  rehabBody: { ar: "جلسات حركة مائية منخفضة الصدمات ومكيفة حسب الاحتياج، دون تقديم وعود طبية أو استبدال الرعاية المتخصصة.", en: "Low-impact aquatic movement sessions adapted to individual needs, without medical claims or replacing specialist care." },
  podTitle: { ar: "أصحاب الهمم", en: "People of Determination" },
  podBody: { ar: "تواصل هادئ، خطوات واضحة، وتدرج مبني على الاستجابة الفردية داخل الماء.", en: "Calm communication, clear steps, and progress based on each person's response in the water." },
  ...
  settingsUnavailable: {
    ar: "الحجز متوقف مؤقتًا حتى يتم تحميل إعدادات النشاط من الخادم.",
    en: "Booking is temporarily unavailable until business settings load from the server.",
  },
