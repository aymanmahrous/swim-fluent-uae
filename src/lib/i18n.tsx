...
export const t = {
  ...
  offer: { ar: "عرض افتتاح خاص وتقييم أولي مجاني", en: "Opening offer with a complimentary first assessment" },
  ...
  feat1d: { ar: "خبرة طويلة في تعليم السباحة وبناء الثقة داخل الماء لمستويات وفئات مختلفة.", en: "Years of practical coaching across different ages, levels, and water-confidence needs." },
