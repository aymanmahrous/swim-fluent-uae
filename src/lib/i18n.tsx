...
export const t = {
  ...
  heroBody: { ar: "من أول خوف من الماء إلى تحسين التقنية والأداء، تبدأ الخطة بتقييم واضح وتدريب مناسب لحالتك مع كوتش أيمن.", en: "From first-time water fear to stronger technique and performance, your plan starts with a clear assessment and coaching built around you with Coach Ayman." },
  heroTrustLine: { ar: "كوتش أيمن · تدريب خاص وجماعي · أبوظبي", en: "Coach Ayman · Private & Group coaching · Abu Dhabi" },
  heroBookCta: { ar: "ابدأ حجز حصتك", en: "Start your lesson booking" },
  coachExperience: { ar: "حصص خاصة أو مجموعات صغيرة حتى 4 متدربين", en: "Private lessons or small groups of up to 4" },
