...
export const t = {
  ...
  bookSession: { ar: "ابدأ حجز حصتك", en: "Start your lesson booking" },
  ...
  heroEyebrow: { ar: "دروس سباحة في أبوظبي • خاص ومجموعات صغيرة", en: "Swimming Lessons in Abu Dhabi • Private & Small Group" },
  heroTitle: { ar: "ابدأ السباحة بثقة، من مستواك الحالي.", en: "Build swimming confidence from your current level." },
  heroBody: { ar: "للمبتدئين، والخوف من الماء، وتطوير المهارات والتقنية. تدريب واضح مع كوتش أيمن يبدأ بفهم نقطة البداية والهدف.", en: "For beginners, water confidence, and skill development. Clear coaching with Coach Ayman starts by understanding your level and goal." },
  ...
  wizardIntro: { ar: "خطوات سريعة تساعدنا نفهم احتياجك ونراجع أنسب موقع وموعد قبل التأكيد.", en: "A few quick steps to help us understand your needs and review the best location and timing before confirming." },
