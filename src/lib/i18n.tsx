...
export const t = {
  ...
  why: { ar: "الأمان أولاً، ثم المهارة", en: "Safety First, Then Skill" },
  feat1: { ar: "مجموعات صغيرة حقيقية", en: "Truly Small Groups" },
  feat1d: { ar: "4 أطفال كحد أقصى — توجيه شخصي واهتمام حقيقي لكل طفل.", en: "Max 4 children — personal guidance and real attention for every child." },
  feat2: { ar: "مدرب معتمد دولياً", en: "Internationally Certified Coach" },
  feat2d: { ar: "خبرة تدريبية، إسعافات وإنقاذ.", en: "Experienced coaching, first aid & rescue certified." },
  feat3: { ar: "داخل مدارس ICS", en: "Inside ICS Schools" },
  feat3d: { ar: "مسابح دافئة ونظيفة في النجدة والفلاح وخليفة ومشرف.", en: "Warm, clean pools in Najda, Al Falah, Khalifa and Mushrif." },
  feat4: { ar: "تقدم منظم في السباحة", en: "Structured Swimming Progress" },
  feat4d: { ar: "نبدأ من الخوف من الماء حتى السباحة الحرة.", en: "From water fear to freestyle swimming." },
  ...
  coachExperience: { ar: "خبرة تدريبية في أبوظبي", en: "Experienced coaching in Abu Dhabi" },
  ...
  wizardIntro: { ar: "أربع خطوات قصيرة تساعدنا على فهمك قبل التواصل.", en: "Four short steps help us understand you before we contact you." },
  stepAbout: { ar: "بياناتك", en: "About You" },
  stepProfile: { ar: "الحالة", en: "Profile" },
  stepProfileGoal: { ar: "الحالة والتدريب", en: "Profile & Coaching" },
  ...
  faqQ1: { ar: "هل التدريب مناسب للمبتدئين تمامًا؟", en: "Is the coaching suitable for complete beginners?" },
  faqA1: { ar: "نعم، التدريب مصمم للبدء من نقطة الصفر مع أساسيات التنفس والطفو والحركة.", en: "Yes, coaching is designed to start from zero with breathing, floating, and movement basics." },
  faqQ2: { ar: "هل يمكن التعامل مع الخوف من الماء؟", en: "Can fear of water be addressed?" },
  faqA2: { ar: "نعم، نتعامل مع الخوف من الماء بتدرج هادئ وآمن يبني الثقة خطوة بخطوة.", en: "Yes, fear of water is addressed with a calm, gradual progression that builds confidence step by step." },
  faqQ3: { ar: "ما الفرق بين التدريب الخاص والجماعي؟", en: "What's the difference between Private and Group training?" },
  faqA3: { ar: "التدريب الخاص فردي بالكامل مع الكوتش، بينما التدريب الجماعي يجمع عدة متدربين في نفس الحصة.", en: "Private training is fully one-on-one with the coach, while Group training includes several learners in the same session." },
  faqQ4: { ar: "ما الحد الأقصى لعدد المتدربين في المجموعة؟", en: "What is the maximum group size?" },
  faqA4: { ar: "الحد الأقصى للمجموعة الواحدة هو 4 متدربين.", en: "The maximum size for one group is 4 learners." },
  faqQ5: { ar: "كم تستغرق الحصة الواحدة؟", en: "How long is a session?" },
  faqA5: { ar: "مدة الحصة التدريبية العادية 45 دقيقة.", en: "A standard swimming lesson is 45 minutes." },
  faqQ6: { ar: "أين تقام الحصص؟", en: "Where are sessions held?" },
  faqA6: { ar: "تقام الحصص في أربعة مواقع في أبوظبي: ICS Al Najda وICS Al Falah وICS Khalifa وICS Al Mushrif.", en: "Sessions are held at four Abu Dhabi locations: ICS Al Najda, ICS Al Falah, ICS Khalifa, and ICS Al Mushrif." },
  faqQ7: { ar: "هل يعني إرسال النموذج تأكيد الموعد؟", en: "Does submitting the form confirm my appointment?" },
  faqA7: { ar: "لا، إرسال النموذج هو طلب حجز فقط، ولا يعني تأكيد الموعد تلقائيًا. سيتواصل الفريق معك لتأكيد الموعد.", en: "No, submitting the form is a booking request only and does not automatically confirm an appointment. Our team will contact you to confirm." },
} satisfies Dict;
