...
const [
  ...
  read("src/components/public-home.tsx"),
...
for (const value of [
  ...
  "حصتان أسبوعيًا",
  "2 Sessions per Week",
  "400 درهم شهريًا بدلًا من 450",
  "AED 400/month instead of AED 450",
  "150 درهم / للحصة",
  "AED 150 / Session",
  "45–60 دقيقة",
  "45–60 Minutes",
]) {
  assert.ok(publicHome.includes(value), `Missing approved website offer contract: ${value}`);
}
...
for (const value of [
  ...
  "groupMonthlyPriceAED",
  "groupSessionsPerWeek",
  "siblingMonthlyPriceAED",
  "privateSessionPriceAED",
  "privateSessionDurationMinutes",
  "الحصة الخاصة بسعر",
  "A private lesson is AED",
  "إرسال الطلب لا يعني أن الموعد أصبح مؤكدًا",
