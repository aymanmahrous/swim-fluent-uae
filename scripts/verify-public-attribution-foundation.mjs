...
console.log("Public attribution foundation verified: normalized UTM allow-list, click-ID removal, PII rejection, bounded lengths, and no persistence or external writes.");
